...
select getdate()
INSERT INTO [dbo].[Member] ([userName], [password], [firstName], [lastName], [email], [birthday], [gender], [phone], [RegisteredDate], [address], [avatar], [status], [roleId]) VALUES (N'admin', N'b0c5d581021ef18440beba13df1e1fb4', N'Nguyễn', N'Hùng', N'Hungqaz38@gmail.com', CAST(N'2002-11-20' AS Date), 1, N'0334975825', CAST(N'2022-05-28 17:41:12.077' AS datetime), N'Hà Tĩnh', N'~/Content/img/avatar/avatar.jpg', 1, 1)
-- [Product]
